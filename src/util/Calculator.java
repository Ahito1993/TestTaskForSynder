...
public class Calculator {
    ...
    public static void calculate(String expression) throws InvalidDataException {
        ...
        for (int i = 0; i < tokensRPN.size(); i++) {
            ...
            switch (tokensRPN.get(i)) {
                ...
                case ("*"):
                    ...
                    break;
                case ("/"):
                    if (stack.peek() == 0) throw new ArithmeticException("Попытка деления на 0");
    ...
    private static void displayRPN(List<String> tokens) {
